import { getElectricalInventory } from "../../BackEnd/electricalInventoryBackEnd.js";
import { setSelectedData, setIsEdit } from "../inventory/state.js";
import { loadPage } from "./controlPage.js";

export async function mainElectricalInventory() {
  await getAllElectricalInventory();
  ...
  async function getAllElectricalInventory() {
    const item = await getElectricalInventory();
  ...
  function renderInventory(id, name, range, brand, type, qty) {
    ...
    editButton.addEventListener("click", () => {
      ...
      document.getElementById("Electrical").classList.remove("active");
      document.getElementById("Inventory").classList.remove("active");
      document.getElementById("Partin").classList.add("active");
      const partInURL = "UI/pages/partin.html";
      setSelectedData(id, name, range, brand, type, qty, "Electrical");
      setIsEdit(true);
      loadPage(partInURL);
